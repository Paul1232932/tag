...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    P2.setPosition(randint(0, 160), randint(0, 160))
})
let P2: Sprite = null
...
let P1 = sprites.create(img`
    ...
    . . . . f f f . . . . . . . . . 
    `, SpriteKind.Player)
P1.setPosition(randint(0, 160), randint(0, 120))
controller.moveSprite(P1, 100, 150)
...
P2.follow(P1, info.score())
music.play(music.createSong(assets.song`E`), music.PlaybackMode.LoopingInBackground)
